...
import {Grid, Image, Card, Dimmer, Icon} from 'semantic-ui-react';
...
class MainComponent extends React.Component {
  ...
  //   //console.log("usertype at logout: ",cookies.get('userType'));
  //   if(cookies.get('userType') == undefined){
  //   //console.log("inside at logout: ",cookies.get('userType'));
  //     hashHistory.push('/');
  //   }
  // }
  getallData() {
  ...
  render() {
    ...
    if (cookies.get('userType') == "User" || cookies.get('userType') == "Pair") {
      landing = (<div>
        ...
        <Card onMouseEnter ={this.handleShow}  onMouseLeave={this.handleHide} style={{textDecoration:'none',width:'25%',paddingTop:'4%',paddingBottom:'4%'}} color='teal' raised={true} >
           <Card.Content style={{textAlign:"left"}}>
            <Card.Header style={{fontSize:"98%",marginRight:"13%"}}>
    ...
    <Card onMouseEnter ={this.handleShow1}  onMouseLeave={this.handleHide1} style={{textDecoration:'none',width:'25%',paddingTop:'4%',paddingBottom:'4%'}} color='teal' raised={true} >
               <Card.Content style={{textAlign:"left"}}>
                <Card.Header style={{fontSize:"98%",marginRight:"13%"}}>
    ...
    <Grid.Column>
      <div className='checking'><iframe style={{width:"273px",marginTop:"26%",marginLeft:"7%"}} src="https://www.youtube.com/embed/dM_KbsCVqzo?rel=0&amp;showinfo=0" frameBorder="0" allowFullScreen></iframe></div>
  </Grid.Column>
</Grid.Row>
</Grid>
<nav className="navbar navbar-fixed-bottom" id="footer" >
 <div id = "ribbon" className="row footer-brand-colour">
    ...
    <Link to="/credits" > <a id="creditPage">Credits</a></Link>
  </p>
  </nav>
      </div>);
    } else {
