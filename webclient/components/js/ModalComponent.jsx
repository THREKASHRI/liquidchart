...
class Component2 extends React.Component {
  ...
  render() {
    //console.log("in model component ",this.props.loginid);
    var context = this;
    let btn ='';
    ...
    if(this.props.status == 'wip'){
          ...
          btn = (<Popup
          trigger={
            <Label as='a' corner style={{borderColor:'#5b6a92'}}><Icon name="send"/></Label>
          ...
          trigger={<Image label={{
            ...
            icon: 'check circle',
              color:'green'
          }}/>} position='bottom center' content='Completed' style={{marginLeft:'8%'}}/>);
        }
        // var displayname ='';
        // if(this.props.status == 'wip'){
        //   displayname = (<Card.Meta>Selected by:{this.props.loginid}{this.props.name}</Card.Meta>);
        // }
    ...
    return (
      <Card style={{textDecoration:'none'}} color='teal' raised={true} onClick={this.abc.bind(this)}>
        ...
        <Button style={{backgroundColor:"#4c8bda",color:"white"}} onClick={this.abc.bind(this)} >More<Icon name="arrow circle right" size="large"/></Button>
