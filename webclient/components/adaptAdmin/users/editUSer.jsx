...
export default class AddUser extends React.Component {
  ...
  typeChange(e,a) {
    //console.log("edit change ",a.value  );
  ...
  checkForOnlyAlphaAlert() {
    //console.log("inside check for only alpha alert");
    let context = this;
    this.refs.asd.error(
  ...
  checkForEnterCorrectUserTypeAlert() {
    //console.log("inside check for Enter correct User type alert");
    let context = this;
    this.refs.asd.error(
  ...
  checkForUserDataUpdatedSuccessfullyAlert() {
    //console.log("inside check for user data updated successfully alert");
    let context = this;
  ...
  updateUser() {
    let UserName = this.refs.newEmployeeName.value;
  ...
  getUsers() {
    ...
    $.ajax({
      ...
      success: function(data)
      {
        //console.log('in delete domain'+Object.keys(data));
            ...
            <Grid.Column width={14}>
              ...
              <Form onSubmit={this.addNewUser}>
                ...
                <Form.Field>
                  ...
                  {/* <input autoComplete='off' type='text' onChange={this.typeChange} value={this.state.userType} name='usertype' ref='usertype' placeholder='Admin or user' required/> */}
                </Form.Field>
                {teamfield}
              </Form>
