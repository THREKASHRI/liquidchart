      ...
      <Grid.Row>
        ...
        <Grid.Column width={14}>
          ...
          <Form>
            <Form.Field>
              <label>
                <p style={{fontSize:"14px",fontFamily:"arial"}}>Session Name</p>
              </label>
            ...
            <Form.Field>
              <label>
                <p style={{fontSize:"14px",fontFamily:"arial"}}>
                  Select the teams to link this session
                </p>
              </label>
              <input autoComplete='off' type='text' ref='video' placeholder='video link' required/>
            </Form.Field>
          </Form>
          <Grid.Column width={6}><Button style={{marginTop:"10px"}} fluid color='green'
            onClick={this.validateData}>Add</Button></Grid.Column>
          <Divider/>
        </Grid.Column>
        <Grid.Column width={1}/>
      </Grid.Row>
