...
export default class AdminMenu extends Component {
  ...
  render() {
    //console.log(this.state.activeItem + 'state');
    ...
    return (
      <div id="leftmenu">
        ...
        marginBottom: "0px"
              ...
              {/* <Accordion.Title id="accordian" color="black">
              <Icon name='unlock alternate' size='large' style={{float:'left',color:'#737373'}}/>
              <b>Change password</b>
            </Accordion.Title><Divider style={{marginBottom:"0px"}}/>
            <Accordion.Content >

            </Accordion.Content> */}
            </Accordion>
          </Sidebar><br/><br/><br/> {/* <Sidebar.Pusher className='container' id="sidebarpusher">
